...
unnorm_df$phenograph_cluster <- factor(membership(phen_results[[2]]))
...
Number of clusters unnormalized is `r length(unique(unnorm_df$phenograph_cluster))`. Number of clusters normalized is `r length(unique(norm_df$phenograph_cluster))`
...
Calculated Ripley's K for immune cells. 
...
Pick high and low K subject, plot
...
low_k = "030120 P9HuP6 TMA 1-B_Core[1,8,C]_[10220,50714].im3"
high_k = "030120 P9HuP6 TMA 1-B_Core[1,5,G]_[18855,43857].im3"


# also color by immune cells
# maybe include all cells in plot though?
cell_level_ovarian %>%
     filter(tissue_category == "Tumor",
            phenotype_cd19 == "CD19+" | phenotype_cd8 == "CD8+" |
              phenotype_cd3 == "CD3+" | phenotype_cd68 == "CD68+",
...
high_k = "030120 P9HuP6 TMA 1-A_Core[1,2,E]_[14671,40936].im3"
cell_level_ovarian %>%
     filter(tissue_category == "Tumor",
            phenotype_cd19 == "CD19+" | phenotype_cd8 == "CD8+" |
              phenotype_cd3 == "CD3+" | phenotype_cd68 == "CD68+",
